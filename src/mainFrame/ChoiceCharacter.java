...
public class ChoiceCharacter extends JFrame implements ActionListener {
	...
	private void initData() {
		...
		backgroundImage = new JLabel(new ImageIcon("C:/manonRush_project/rushGG/images/choiceBackground.png"));
		setContentPane(backgroundImage);

		ImageIcon wizardImg = new ImageIcon("C:/manonRush_project/rushGG/images/wizardChoiceImage.png");
		wizardLabel = new JLabel(wizardImg);

		ImageIcon warriordImg = new ImageIcon("C:/manonRush_project/rushGG/images/warriorChoiceImage.png");
		warriorLabel = new JLabel(warriordImg);

		ImageIcon choiceWizardBtn = new ImageIcon("C:/manonRush_project/rushGG/images/choiceWizard.png");
		choiceWizard = new JButton(choiceWizardBtn);

		ImageIcon choiceWarriorBtn = new ImageIcon("C:/manonRush_project/rushGG/images/choiceWarrior.png");
		choiceWarrior = new JButton(choiceWarriorBtn);

		ImageIcon startBtnImg = new ImageIcon("C:/manonRush_project/rushGG/images/startBtn.png");
