...
public class Ground extends JFrame {
	...
	private void initData() {
		...
		if (modeCount == 1) {
			// 마법사 / 노말
			backgroundNormalImage = new JLabel(
					new ImageIcon("C:/manonRush_project/rushGG/images/bossBackgroundMap.jpg"));
			...
			// 마법사 / 헬
			backgroundHellImage = new JLabel(
					new ImageIcon("C:/manonRush_project/rushGG/images/bossBackgroundMapHell.jpg"));
