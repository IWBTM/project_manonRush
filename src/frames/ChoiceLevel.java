...
public class ChoiceLevel extends JFrame implements ActionListener {
	...
	private void initData() {
		...
		backgroundImage = new JLabel(new ImageIcon("C:/manonRush_project/rushGG/images/choiceLevelBakcground.jpg"));
		setContentPane(backgroundImage);

		ImageIcon choiceNormalBtn = new ImageIcon("C:/manonRush_project/rushGG/images/choiceLevelNormal.png");
		choiceNormal = new JButton(choiceNormalBtn);

		ImageIcon choiceHellBtn = new ImageIcon("C:/manonRush_project/rushGG/images/choiceLevelHell.png");
		choiceHell = new JButton(choiceHellBtn);

		ImageIcon nomalHover = new ImageIcon("C:/manonRush_project/rushGG/images/choiceLevelNormalHover.png");
		ImageIcon hellHover = new ImageIcon("C:/manonRush_project/rushGG/images/choiceLevelHellHover.png");
