...
public class GameState extends JFrame implements ActionListener {
	...
	private void initData() {
		...
		if (stateCount == 1) {
			backgroundClearImage = new JLabel(new ImageIcon("C:/manonRush_project/rushGG/images/gameClearBackground.jpg"));
			setContentPane(backgroundClearImage);

		} else if (stateCount == 0) {
			backgroundOverImage = new JLabel(new ImageIcon("C:/manonRush_project/rushGG/images/gameOverBackground.jpg"));
			setContentPane(backgroundOverImage);
		}

		ImageIcon yesBtnImage = new ImageIcon("C:/manonRush_project/rushGG/images/gameOverReStartYesBtn.png");
		yesBtn = new JButton(yesBtnImage);

		ImageIcon noBtnImage = new ImageIcon("C:/manonRush_project/rushGG/images/gameOverReStartNoBtn.png");
		noBtn = new JButton(noBtnImage);

		ImageIcon yesBtnImageHover = new ImageIcon("C:/manonRush_project/rushGG/images/gameOverReStartYesHoverBtn.png");
		ImageIcon noBtnImageHover = new ImageIcon("C:/manonRush_project/rushGG/images/gameOverReStartNoHoverBtn.png");
